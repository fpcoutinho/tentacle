...
import { dto } from './get-mission-bookmark.dto.ts'
import { service } from './get-mission-bookmark.service.ts'

export async function getMissionBookmark(req: Request, res: Response): Promise<void> {
  if (!req.user) {
